...
11/23: basic banagrams library
11/29: graphical user interface connecting to banagrams server hosting the game
12/1: banagrams solver to suggest a move
12/5: 60% testing coverage (and all implementation done for checkpoint)
Final demo day: remainder of testing code